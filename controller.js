...
(function() {
  var Acolyte, Adventurer, BigAcolyte, BigMinion, BigMonster, CanvasInitializer, Dungeon, DungeonData, HugeAcolyte, HugeMinion, HugeMonster, Map, Minion, Monster, Room, RoomConnection, SmallAcolyte, SmallMinion, SmallMonster, app, guid, humanize, unitTypes,
  ...
  app.service('dungeon', Dungeon = (function() {
    ...
    Dungeon.prototype.updateRoomCanvas = function() {
      var acolyteChart, acolyteChartElement, color, i, j, k, l, m, minionChart, minionChartElement, ref, ref1, ref2, ref3, room, unitRepresentation;
          ...
          datasets: [
            {
              ...
              data: [this.data.smallAcolytes * 10, this.data.acolytes * 160, this.data.bigAcolytes * 2560, this.data.hugeAcolytes * 40960],
      ...
      return minionChart = new Chart(minionChartElement, {
        type: 'pie',
        data: {
          labels: ['Small', 'Normal', 'Big', 'Huge'],
          datasets: [
            {
              label: 'Reputation generated',
              data: [this.data.smallMinions * 10, this.data.minions * 160, this.data.bigMinions * 2560, this.data.hugeMinions * 40960],
              backgroundColor: ['rgba(255, 99, 132, 0.2)', 'rgba(54, 162, 235, 0.2)', 'rgba(255, 206, 86, 0.2)', 'rgba(75, 192, 192, 0.2)'],
              borderColor: ['rgba(255,99,132,1)', 'rgba(54, 162, 235, 1)', 'rgba(255, 206, 86, 1)', 'rgba(75, 192, 192, 1)'],
              borderWidth: 0
            }
