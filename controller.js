...
(function() {
  var Acolyte, Adventurer, BigAcolyte, BigMinion, BigMonster, CanvasInitializer, Dungeon, DungeonData, HugeAcolyte, HugeMinion, HugeMonster, Map, Minion, Monster, Room, RoomConnection, SmallAcolyte, SmallMinion, SmallMonster, app, guid, humanize, nextTierReputation, unitSizes, unitTypes,
  ...
  app.service('dungeon', Dungeon = (function() {
    function Dungeon($rootScope) {
      this.disintegrate = bind(this.disintegrate, this);
      this.ritual = bind(this.ritual, this);
      this.diplomacy = bind(this.diplomacy, this);
      this.razeTown = bind(this.razeTown, this);
      ...
      this.unitWithLowestHp = bind(this.unitWithLowestHp, this);
      this.anyUnitsActive = bind(this.anyUnitsActive, this);
      ...
      this.unitSize = bind(this.unitSize, this);
      ...
      this.upgradeKillBonus = bind(this.upgradeKillBonus, this);
      this.upgradeUnitCombat = bind(this.upgradeUnitCombat, this);
      ...
      this.killBonusUpgradeETA = bind(this.killBonusUpgradeETA, this);
      this.unitCombatUpgradeETA = bind(this.unitCombatUpgradeETA, this);
      ...
      this.upgradeKillBonusText = bind(this.upgradeKillBonusText, this);
      this.upgradeUnitCombatText = bind(this.upgradeUnitCombatText, this);
      ...
      this.killBonusUpgradeProgressPercent = bind(this.killBonusUpgradeProgressPercent, this);
      this.unitCombatUpgradeProgressPercent = bind(this.unitCombatUpgradeProgressPercent, this);
      ...
      this.data.roomObjects[0].occupantType = unitTypes.smallMonster;
      this.data.roomObjects[0].population = 5;
      for (i = n = 0, ref3 = this.data.smallMonsters - 1; 0 <= ref3 ? n <= ref3 : n >= ref3; i = 0 <= ref3 ? ++n : --n) {
        this.data.roomObjects[0].monsters[i] = this.data.monsterObjects[i];
      }
      this.data.roomObjects[1] = new Room();
      this.data.roomObjects[1].population = 5;
      this.data.roomObjects[1].size = 10;
      this.data.roomObjects[1].occupantType = unitTypes.smallMinion;
      for (i = o = 0, ref4 = this.data.smallMinions - 1; 0 <= ref4 ? o <= ref4 : o >= ref4; i = 0 <= ref4 ? ++o : --o) {
        this.data.roomObjects[1].minions[i] = this.data.minionObjects[i];
      }
      ...
      this.data.roomObjects[5] = new Room();
      this.data.roomObjects[5].occupantType = unitTypes.treasure;
      ...
      this.data.unitCombatMultiplier = 1;
      this.data.unitCombatUpgradeCost = Math.floor(15000 * 0.2);
      this.data.unitCombatUpgradeNumber = 1;
      this.data.killBonus = 0;
      this.data.killBonusUpgradeCost = Math.floor(15000 * 0.2);
      this.data.killBonusUpgradeNumber = 1;
      this.data.cost = 4000;
      this.data.adventurerMultiplier = 1;
    ...
    Dungeon.prototype.tick = function() {
      ...
      for (k = 0, len = ref.length; k < len; k++) {
        minion = ref[k];
        for (i = l = 1, ref1 = this.data.devMultiplier; 1 <= ref1 ? l <= ref1 : l >= ref1; i = 1 <= ref1 ? ++l : --l) {
      ...
      for (m = 0, len1 = ref2.length; m < len1; m++) {
        acolyte = ref2[m];
        for (i = n = 1, ref3 = this.data.devMultiplier; 1 <= ref3 ? n <= ref3 : n >= ref3; i = 1 <= ref3 ? ++n : --n) {
      ...
      for (o = 0, len2 = ref4.length; o < len2; o++) {
        monster = ref4[o];
        for (i = p = 1, ref5 = this.data.devMultiplier; 1 <= ref5 ? p <= ref5 : p >= ref5; i = 1 <= ref5 ? ++p : --p) {
          monster.tick();
        }
      }
    ...
    Dungeon.prototype.acolyteTick = function(acolyte) {
      ...
      if (acolyte.health >= acolyte.maxHealth) {
        rep = acolyte.reputation * this.data.devMultiplier * this.data.acolyteMultiplier;
        this.data.reputation += rep;
        this.data.totalReputationEarned += rep;
        return this.data.currentTierReputation += rep;
      }
    };
    ...
    Dungeon.prototype.updateValues = function() {
      ...
      for (i = k = 0, ref = Math.floor(this.data.treasure * this.data.devMultiplier) - 1; 0 <= ref ? k <= ref : k >= ref; i = 0 <= ref ? ++k : --k) {
        adventurerRoll = Math.floor((Math.random() * Math.floor(14500 / this.data.adventurerMultiplier)) + 1);
        if (adventurerRoll === Math.floor(14500 / this.data.adventurerMultiplier) && this.data.dungeonOpen) {
          this.runDungeon();
        }
      }
    ...
    Dungeon.prototype.unitCombatUpgradeProgressPercent = function() {
      if (this.data.reputation >= this.data.unitCombatUpgradeCost) {
        return '100';
      }
      return (this.data.reputation / this.data.unitCombatUpgradeCost * 100).toString();
    };

    Dungeon.prototype.killBonusUpgradeProgressPercent = function() {
      if (this.data.reputation >= this.data.killBonusUpgradeCost) {
        return '100';
      }
      return (this.data.reputation / this.data.killBonusUpgradeCost * 100).toString();
    };
    ...
    Dungeon.prototype.upgradeAcolytesText = function() {
      return "Upgrade Acolytes " + this.data.acolyteUpgradeNumber + " (" + (humanize(this.data.acolyteUpgradeCost)) + " reputation). Upgrading acolytes increases their effectiveness by 20%";
    };

    Dungeon.prototype.upgradeMonstersText = function() {
      return "Upgrade Monsters " + this.data.monsterUpgradeNumber + " (" + (humanize(this.data.monsterUpgradeCost)) + " reputation). Upgrading monsters increases their leveling speed by 20%";
    };
    ...
    Dungeon.prototype.unitCombatUpgradeETA = function() {
      var eta, rate, remaining;
      if (this.data.reputation > this.data.unitCombatUpgradeCost) {
        remaining = 0;
      } else {
        remaining = this.data.unitCombatUpgradeCost - this.data.reputation;
      }
      rate = (this.data.smallAcolytes + (this.data.acolytes * 16) + (this.data.bigAcolytes * 256) + (this.data.hugeAcolytes * 4096)) * this.data.devMultiplier * this.data.acolyteMultiplier;
      eta = Math.floor(remaining / rate);
      return this.humanizeETA(eta);
    ...
    Dungeon.prototype.killBonusUpgradeETA = function() {
      var eta, rate, remaining;
      if (this.data.reputation > this.data.killBonusUpgradeCost) {
        remaining = 0;
      } else {
        remaining = this.data.killBonusUpgradeCost - this.data.reputation;
      }
      rate = (this.data.smallAcolytes + (this.data.acolytes * 16) + (this.data.bigAcolytes * 256) + (this.data.hugeAcolytes * 4096)) * this.data.devMultiplier * this.data.acolyteMultiplier;
      eta = Math.floor(remaining / rate);
      return this.humanizeETA(eta);
    ...
    Dungeon.prototype.tierETA = function() {
      ...
      if (this.data.currentTierReputation > nextTierReputation[this.data.dungeonLevel - 1]) {
        ...
        remaining = nextTierReputation[this.data.dungeonLevel - 1] - this.data.currentTierReputation;
      }
      rate = (this.data.smallAcolytes + (this.data.acolytes * 16) + (this.data.bigAcolytes * 256) + (this.data.hugeAcolytes * 4096)) * this.data.devMultiplier * this.data.acolyteMultiplier;
      eta = Math.floor(remaining / rate);
      return this.humanizeETA(eta);
    ...
    Dungeon.prototype.roomMouseUp = function(options) {
      var boundaries, i, k, ref, room, swapAcolytes, swapMinions, swapMonsters, swapOccupantType, swapPopulation, swapSize, x, y;
      ...
      for (i = k = 0, ref = this.data.roomObjects.length - 1; 0 <= ref ? k <= ref : k >= ref; i = 0 <= ref ? ++k : --k) {
        ...
        if (x >= boundaries[0] * 12 && x <= (boundaries[2] + 1) * 12 && y >= boundaries[1] * 12 && y <= (boundaries[3] + 1) * 12) {
          ...
          if (this.data.dragRoom !== null) {
            ...
            swapAcolytes = this.data.roomObjects[this.data.dragRoom].acolytes;
            swapMinions = this.data.roomObjects[this.data.dragRoom].minions;
            ...
            this.data.roomObjects[this.data.dragRoom].acolytes = this.data.roomObjects[this.data.dropRoom].acolytes;
            this.data.roomObjects[this.data.dragRoom].minions = this.data.roomObjects[this.data.dropRoom].minions;
            ...
            this.data.roomObjects[this.data.dropRoom].acolytes = swapAcolytes;
            this.data.roomObjects[this.data.dropRoom].minions = swapMinions;
            this.updateRoomCanvas();
          }
          return;
        }
    ...
    Dungeon.prototype.emptyRooms = function() {
      ...
      for (k = 0, len = ref.length; k < len; k++) {
        room = ref[k];
        if (room.population === 0 && room.occupantType !== unitTypes.treasure) {
          count += 1;
        }
      }
      return count;
    ...
    Dungeon.prototype.calculateRoomCapacityForBuyAll = function(unitType, max) {
      ...
      if (number === max + 1) {
        ...
        return Math.min(number, this.maxNumberToBuy(unitType));
      }
    };
    ...
    Dungeon.prototype.upgradeMinions = function() {
      if (this.data.reputation >= this.data.minionUpgradeCost) {
        ...
        this.data.minionUpgradeCost = Math.floor(this.data.minionUpgradeCost * 2 * 1.2);
        return this.updateRoomCanvas();
      }
    };
    ...
    Dungeon.prototype.upgradeAcolytes = function() {
      if (this.data.reputation >= this.data.acolyteUpgradeCost) {
        ...
        this.data.acolyteUpgradeCost = Math.floor(this.data.acolyteUpgradeCost * 2 * 1.2);
        return this.updateRoomCanvas();
      }
    };
    ...
    Dungeon.prototype.upgradeUnitCombat = function() {
      var acolyte, k, l, len, len1, minion, ref, ref1;
      if (this.data.reputation >= this.data.unitCombatUpgradeCost) {
        this.data.reputation -= this.data.unitCombatUpgradeCost;
        this.data.unitCombatUpgradeNumber += 1;
        this.data.unitCombatMultiplier = this.data.unitCombatMultiplier * 1.02;
        this.data.unitCombatUpgradeCost = Math.floor(this.data.unitCombatUpgradeCost * 2 * 1.02);
        ref = this.data.acolyteObjects;
        for (k = 0, len = ref.length; k < len; k++) {
          acolyte = ref[k];
    ...
    Dungeon.prototype.upgradeKillBonus = function() {
      if (this.data.reputation >= this.data.killBonusUpgradeCost) {
        this.data.reputation -= this.data.killBonusUpgradeCost;
        this.data.killBonusUpgradeNumber += 1;
        this.data.killBonus += 30;
        this.data.killBonusUpgradeCost = Math.floor(this.data.killBonusUpgradeCost * 2 * 1.02);
        return this.updateRoomCanvas();
      }
    };
    ...
    Dungeon.prototype.runDungeon = function() {
      var adventurer, done, hasTreasure, room;
      this.narrate('A level ' + this.data.dungeonLevel.toString() + ' adventurer arrives!');
      adventurer = new Adventurer(this.data.dungeonLevel);
      done = false;
      room = null;
      hasTreasure = false;
      while (!done) {
      ...
      if (this.data.treasure > 1) {
        ...
        return this.narrate('The adventurer has successfully escaped with one of your treasures!');
      } else {
        return this.narrate('The adventurer finds nothing and leaves.');
      }
    };

    Dungeon.prototype.unitName = function(type) {
      switch (type) {
        case unitTypes.smallMinion:
          return 'small minion';
        case unitTypes.smallAcolyte:
          return 'small acolyte';
        case unitTypes.smallMonster:
          return 'small monster';
        case unitTypes.minion:
          return 'minion';
        case unitTypes.acolyte:
          return 'acolyte';
        case unitTypes.monster:
          return 'monster';
        case unitTypes.bigMinion:
          return 'big minion';
        case unitTypes.bigAcolyte:
          return 'big acolyte';
        case unitTypes.bigMonster:
          return 'big monster';
        case unitTypes.hugeMinion:
          return 'huge minion';
        case unitTypes.hugeAcolyte:
          return 'huge acolyte';
        case unitTypes.hugeMonster:
          return 'huge monster';
        case unitTypes.treasure:
          return 'treasure';
        default:
          return 'nothing';
      }
    ...
    Dungeon.prototype.unitSize = function(type) {
      switch (type) {
        case unitTypes.smallMinion:
    ...
    Dungeon.prototype.encounterMonsters = function(adventurer, room) {
      ...
      if (adventurer.hp <= 0) {
        this.defeatAdventurer(room, adventurer);
        return true;
      } else {
        return false;
      }
    ...
    Dungeon.prototype.doCombat = function(adventurer, room) {
      var acolyte, k, l, len, len1, len2, m, minion, monster, ref, ref1, ref2, results1, turnRoll;
      if (this.anyUnitsActive(room)) {
        turnRoll = Math.floor((Math.random() * 2) + 1);
        results1 = [];
        while (adventurer.hp > 0 && this.anyUnitsActive(room)) {
          if (turnRoll === 1) {
            monster = this.unitWithLowestHp(room);
            if (monster !== null) {
            ...
            if (monster.hp <= 0) {
              monster.hp = 0;
              monster.health = 0;
              this.narrate('One of your ' + this.unitName(room.occupantType) + 's has been disabled by an adventurer.');
    ...
    Dungeon.prototype.anyUnitsActive = function(room) {
      var acolyte, k, l, len, len1, len2, m, minion, monster, ref, ref1, ref2;
      ref = room.monsters;
      for (k = 0, len = ref.length; k < len; k++) {
        monster = ref[k];
        if (monster.isActive()) {
    ...
    Dungeon.prototype.unitWithLowestHp = function(room) {
      var acolyte, k, l, len, len1, len2, lowestHp, m, minion, monster, monsterSelected, ref, ref1, ref2;
      lowestHp = 1000000;
      ...
      for (l = 0, len1 = ref1.length; l < len1; l++) {
        acolyte = ref1[l];
        if (acolyte.hp < lowestHp && acolyte.health >= acolyte.maxHealth) {
          lowestHp = acolyte.hp;
      ...
      for (m = 0, len2 = ref2.length; m < len2; m++) {
        minion = ref2[m];
        if (minion.hp < lowestHp && minion.health >= minion.maxHealth) {
          lowestHp = minion.hp;
    ...
    Dungeon.prototype.defeatAdventurer = function(room, adventurer) {
      var k, killBonus, len, monster, ref, xp;
      this.data.adventurers += 1;
      this.data.treasure += adventurer.level;
      killBonus = this.data.killBonus * this.unitSize(room.occupantType);
      this.data.reputation += killBonus;
      ...
      this.narrate('Some of your ' + this.unitName(room.occupantType) + 's have slain the adventurer! You take their ' + adventurer.level + ' treasure!');
      if (killBonus > 0) {
        return this.narrate('You gain ' + killBonus + ' reputation!');
      }
    };
    ...
    Dungeon.prototype.razeTown = function() {
      this.data.adventurerMultiplier *= 1.2;
      if (this.data.adventurerMultiplier > 14500) {
        return this.data.adventurerMultiplier = 14500;
      }
    };

    Dungeon.prototype.diplomacy = function() {
      return this.data.adventurerMultiplier /= 1.2;
    };

    Dungeon.prototype.ritual = function() {
      return this.data.reputation += this.reputationRate() / 10;
    };

    Dungeon.prototype.disintegrate = function() {
      var rate;
      rate = (this.data.smallMinions + (this.data.minions * 16) + (this.data.bigMinions * 256) + (this.data.hugeMinions * 4096)) * this.data.devMultiplier * this.data.minionMultiplier;
      return this.data.roomProgress += rate;
    };
  ...
  app.controller('main', function($scope, dungeon, $rootScope, $cookies, $window) {
    ...
    $scope.$watch('dungeon.data.reputation', function(newVal) {
      ...
      return $scope.buyRoomOfBigAcolytesText = "Fill Room (" + (dungeon.calculateRoomCapacityForBuyAll(unitTypes.bigAcolyte, 2)) + ")";
    });
    $scope.$watch('dungeon.reputationRate()', function(newVal) {
      return $scope.reputationRate = humanize(newVal);
    });
    ...
    $scope.$watch('dungeon.unitCombatUpgradeProgressPercent()', function(newVal) {
      $scope.unitCombatUpgradeProgressPercent = newVal;
      return $scope.unitCombatUpgradeProgressPercentRounded = Math.floor(newVal);
    });
    $scope.$watch('dungeon.killBonusUpgradeProgressPercent()', function(newVal) {
      $scope.killBonusUpgradeProgressPercent = newVal;
      return $scope.killBonusUpgradeProgressPercentRounded = Math.floor(newVal);
    });
    ...
    $scope.$watch('dungeon.unitCombatUpgradeETA()', function(newVal) {
      return $scope.unitCombatUpgradeETA = newVal;
    });
    $scope.$watch('dungeon.killBonusUpgradeETA()', function(newVal) {
      return $scope.killBonusUpgradeETA = newVal;
    });
    ...
    $scope.$watch('dungeon.upgradeUnitCombatText()', function(newVal) {
      return $scope.upgradeUnitCombatText = newVal;
    });
    $scope.$watch('dungeon.upgradeKillBonusText()', function(newVal) {
      return $scope.upgradeKillBonusText = newVal;
    });
    $scope.$watch('dungeon.emptyRooms()', function(newVal) {
      return $scope.emptyRooms = newVal;
    });
    $scope.$watch('dungeon.data.minionMultiplier', function(newVal) {
      return $scope.minionMultiplier = Math.floor(newVal * 100);
    });
    ...
    $scope.$watch('dungeon.data.unitCombatMultiplier', function(newVal) {
      return $scope.unitCombatMultiplier = Math.floor(newVal * 100);
    });
    $scope.$watch('dungeon.data.killBonus', function(newVal) {
      return $scope.killBonus = newVal;
    });
    $scope.$watch('dungeon.data.dungeonLevel', function(newVal) {
      return $scope.dungeonLevel = newVal;
    });
    $scope.$watch('dungeon.tierProgressPercent()', function(newVal) {
      $scope.tierProgressPercent = newVal;
      return $scope.tierProgressPercentRounded = Math.floor(newVal);
    });
    $scope.$watch('dungeon.tierETA()', function(newVal) {
      return $scope.tierETA = newVal;
    });
    $scope.$watch('dungeon.data.adventurerMultiplier', function(newVal) {
      return $scope.adventurerMultiplier = Math.floor(newVal * 100);
    });
    ...
    $scope.timeSkip = function() {
      var days, hours, i, j, k, l, minutes, monster, ref, ref1, results1, seconds, ticks;
      days = this.skipDays;
      ...
      results1 = [];
      for (i = l = 1, ref1 = ticks; 1 <= ref1 ? l <= ref1 : l >= ref1; i = 1 <= ref1 ? ++l : --l) {
        console.log(i, ticks);
        results1.push((function() {
          var len, m, ref2, results2;
          ref2 = this.dungeon.data.monsterObjects;
          results2 = [];
          for (m = 0, len = ref2.length; m < len; m++) {
            ...
            results2.push((function() {
              var n, ref3, results3;
              results3 = [];
              for (j = n = 0, ref3 = this.dungeon.data.devMultiplier - 1; 0 <= ref3 ? n <= ref3 : n >= ref3; j = 0 <= ref3 ? ++n : --n) {
  ...
  Minion = (function() {
    function Minion() {
      ...
      this.health = 2400;
      this.labor = 16;
      this.hp = Math.floor(4 * document.simulator.data.unitCombatMultiplier);
      this.maxHp = Math.floor(4 * document.simulator.data.unitCombatMultiplier);
      this.damage = Math.floor(1 / 16 * document.simulator.data.unitCombatMultiplier);
  ...
  SmallMinion = (function(superClass) {
    ...
    function SmallMinion() {
      ...
      this.labor = 1;
      this.hp = Math.floor(1 * document.simulator.data.unitCombatMultiplier);
      this.maxHp = Math.floor(1 * document.simulator.data.unitCombatMultiplier);
      this.damage = Math.floor(1 / 256 * document.simulator.data.unitCombatMultiplier);
      this.type = unitTypes.smallMinion;
    }
  ...
  BigMinion = (function(superClass) {
    ...
    function BigMinion() {
      ...
      this.labor = 256;
      this.hp = Math.floor(64 * document.simulator.data.unitCombatMultiplier);
      this.maxHp = Math.floor(64 * document.simulator.data.unitCombatMultiplier);
      this.damage = Math.floor(1 * document.simulator.data.unitCombatMultiplier);
      this.type = unitTypes.bigMinion;
    }
  ...
  HugeMinion = (function(superClass) {
    ...
    function HugeMinion() {
      ...
      this.labor = 4096;
      this.hp = Math.floor(1024 * document.simulator.data.unitCombatMultiplier);
      this.maxHp = Math.floor(1024 * document.simulator.data.unitCombatMultiplier);
      this.damage = Math.floor(16 * document.simulator.data.unitCombatMultiplier);
      this.type = unitTypes.hugeMinion;
    }
  ...
  SmallAcolyte = (function(superClass) {
    ...
    function SmallAcolyte() {
      ...
      this.maxHp = Math.floor(1 * document.simulator.data.unitCombatMultiplier);
      this.damage = Math.floor(1 / 256 * document.simulator.data.unitCombatMultiplier);
      this.type = unitTypes.smallAcolyte;
    }
  ...
  BigAcolyte = (function(superClass) {
    ...
    function BigAcolyte() {
      ...
      this.maxHp = Math.floor(64 * document.simulator.data.unitCombatMultiplier);
      this.damage = Math.floor(1 * document.simulator.data.unitCombatMultiplier);
      this.type = unitTypes.bigAcolyte;
    }
  ...
  HugeAcolyte = (function(superClass) {
    ...
    function HugeAcolyte() {
      ...
      this.maxHp = Math.floor(1024 * document.simulator.data.unitCombatMultiplier);
      this.damage = Math.floor(16 * document.simulator.data.unitCombatMultiplier);
      this.type = unitTypes.hugeAcolyte;
    }
  ...
  Adventurer = (function() {
    function Adventurer(level) {
      var multiplier;
      multiplier = this.getMultiplier(level);
      this.hp = 13 * multiplier;
